...
var selectChatroom = function () {
    rl.question("what chatroom do you want to read? \n", function (input) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, rl.question('input name', function (name) { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                loggedInUser = name;
                                return [4 /*yield*/, consumeChatroom(input).catch(function (e) { return console.error("[" + input + "/" + loggedInUser + "] " + e.message, e); })];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
...
var consumeChatroom = function (topic, fromBeginning) {
